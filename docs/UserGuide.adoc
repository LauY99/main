...
The entry will be automatically removed from addressbook once it expires. Coming v1.5
e.g. `expire 1 d/2011-10-10`
...
=== Condensed Help
Open a condensed help screen by default in place of the Google brwoser integration. Coming v1.5
